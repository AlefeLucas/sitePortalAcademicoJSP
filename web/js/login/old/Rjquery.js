...
jQuery.notifyBar = function (settings) {
    ...
    (function ($) {
        ...
        notifyBarNS.SiteUrl = settings.SiteUrl || "/";
      ...
      .attr("id", "__notifyBar");
        ...
        imgClose =  "/resources/images/iconClose.png";

        // Style close button in CSS file
        if (notifyBarNS.close) {
            bar.append(jQuery("<a href='#' class='notify-bar-close'><img src=" + imgClose + " alt='Inserir'/></a>"));
