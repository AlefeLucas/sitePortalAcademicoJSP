 ...
 * @author TI01N-2
 */
public class ServletUpdateCurso extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        CursoBean curso = new CursoBean(id, nome, idProf, hora);
        if (!cursoD.cursoExists(curso.getNomeCurso(), curso.getIdCurso())) {
            cursoD.updateCurso(curso);
